...
//Bu özellikler için bir başlatıcı oluşturmanız gerekmez. Swift derleyicisi, yapı varsayılan değerler olmadan depolanmış özelliklere sahip olsa bile, her yapıya otomatik olarak üye bazında bir başlatıcı sağlar.

struct Reminder: Identifiable {
    var id: String = UUID().uuidString //UUIDFoundation'daki yapı, evrensel olarak benzersiz değerler üretir .
    var title: String
    var dueDate: Date
...
//Bayrak #if DEBUG, uygulamayı sürüm için oluşturduğunuzda ekteki kodun derlenmesini önleyen bir derleme yönergesidir. Bu bayrağı, hata ayıklama yapılarındaki kodu test etmek veya bir sonraki adımda yapacağınız gibi örnek test verileri sağlamak için kullanabilirsiniz.
    ...
    extension Reminder {
       static var sampleData = [
        ...
        Reminder(
            ...
            dueDate: Date().addingTimeInterval(60000.0), notes: "Preview portfolio"),
        Reminder(
